...
st.set_page_config(page_title="Text To Math Problem Solver And Data Search Assistant Chatbot",page_icon="🧮")
st.title("Text To Math Problem Solver and Data Search Assistant Chatbot")
